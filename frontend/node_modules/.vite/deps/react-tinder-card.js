...
var import_react, defineHidden, is, each, toArray, flushCalls, isSSR, createStringInterpolator$1, to, colors$1, skipAnimation, willAdvance, assign, globals, startQueue, currentFrame, prevFrame, priority, frameLoop, clamp, colors, NUMBER, PERCENTAGE, rgb, rgba, hsl, hsla, hex3, hex4, hex6, hex8, createInterpolator, steps, c1, c2, c3, c4, c5, bounceOut, easings, $get, $observers, hasFluidValue, getFluidValue, getFluidObservers, FluidValue, setFluidGetter, setHidden, numberRegex, colorRegex, unitRegex, rgbaRegex, cssVariableRegex, variableToRgba, parseCSSVariable, namedColorRegex, rgbaRound, createStringInterpolator, prefix, once, warnInterpolate, warnDirectCall, observer, resizeHandlers, handleObservation, listeners, cleanupWindowResizeHandler, createResizeHandler, resizeWindow, onResize, progress, SCROLL_KEYS, ScrollHandler, scrollListeners, resizeListeners, onScrollHandlers, getTarget, onScroll, useIsomorphicLayoutEffect, useIsMounted, useOnce, emptyDeps, useReducedMotion;
var init_react_spring_shared_esm = __esm({
  "node_modules/@react-spring/shared/dist/react-spring-shared.esm.js"() {
    ...
    handleObservation = (entries) => entries.forEach(({
      target,
      contentRect
    }) => {
    ...
    getTarget = (container) => container === document.documentElement ? window : container;
    onScroll = (callback, {
      container: _container = document.documentElement
    } = {}) => {
...
var React2, import_react3, matchProp, resolveProp, getDefaultProp, noopTransform, getDefaultProps, DEFAULT_PROPS, RESERVED_PROPS, config, defaults, AnimationConfig, emptyArray, Animation, getCombinedResult, getNoopResult, getFinishedResult, getCancelledResult, BailSignal, SkipAnimationSignal, isFrameValue, nextId$1, FrameValue, $P, HAS_ANIMATED, IS_ANIMATING, IS_PAUSED, hasAnimated, isAnimating, isPaused, setActiveBit, setPausedBit, SpringValue, ACTIVE_EVENTS, BATCHED_EVENTS, nextId, Controller, _excluded$6, SpringContext, ctx, SpringRef, initSpringRef, useSpringRef, useSpringValue, TransitionPhase, nextKey, _excluded$5, useScroll, _excluded$4, useResize, _excluded$3, _excluded2, defaultThresholdOptions, _excluded$2, _excluded$1, _excluded, Interpolation, to2, interpolate2, update2;
...
var import_react_dom, _excluded$22, isCustomPropRE, attributeCache, isUnitlessNumber, prefixKey, prefixes, _excluded$12, domTransforms, pxTransforms, degTransforms, addUnit, isValueIdentity, AnimatedStyle, FluidTransform, primitives, _excluded3, host, animated;
var init_react_spring_web_esm = __esm({
  "node_modules/@react-spring/web/dist/react-spring-web.esm.js"() {
    ...
    init_react_spring_shared_esm();
    init_react_spring_animated_esm();
    _excluded$22 = ["style", "children", "scrollTop", "scrollLeft", "viewBox"];
    isCustomPropRE = /^--/;
    attributeCache = {};
    isUnitlessNumber = {
