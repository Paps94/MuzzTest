...
function CursorCore({
  ...
  const cursorOuterRef = (0, import_react.useRef)();
  const cursorInnerRef = (0, import_react.useRef)();
  ...
  const [isActiveClickable, setIsActiveClickable] = (0, import_react.useState)(false);
  let endX = (0, import_react.useRef)(0);
  let endY = (0, import_react.useRef)(0);
  ...
  const animateOuterCursor = (0, import_react.useCallback)(
    (time) => {
  ...
  const onMouseDown = (0, import_react.useCallback)(() => setIsActive(true), []);
  const onMouseUp = (0, import_react.useCallback)(() => setIsActive(false), []);
  const onMouseEnterViewport = (0, import_react.useCallback)(() => setIsVisible(true), []);
  const onMouseLeaveViewport = (0, import_react.useCallback)(() => setIsVisible(false), []);
...
function AnimatedCursor({
  ...
  return import_react.default.createElement(CursorCore, {
    outerStyle,
    innerStyle,
    color,
    outerAlpha,
